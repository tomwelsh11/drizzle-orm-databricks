...
> {
  static override readonly [entityKind] = 'DatabricksCharBuilder';
...
export class DatabricksChar extends DatabricksColumn<
  ...
  { length: number; enum?: string[] }
> {
  static override readonly [entityKind] = 'DatabricksChar';
...
export function char(name: string, config: { length: number; enum?: string[] }): DatabricksCharBuilder;
